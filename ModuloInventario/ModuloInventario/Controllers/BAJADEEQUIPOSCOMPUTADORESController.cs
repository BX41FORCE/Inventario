...
namespace ModuloInventario.Controllers
{
    public class BAJADEEQUIPOSCOMPUTADORESController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SECUENCIAL,TIPO,SECUANCIALPERSONA,SECUANCIALINGRESOCOMPUTADORES")] BAJADEEQUIPOSCOMPUTADORES bAJADEEQUIPOSCOMPUTADORES)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SECUENCIAL,TIPO,SECUANCIALPERSONA,SECUANCIALINGRESOCOMPUTADORES")] BAJADEEQUIPOSCOMPUTADORES bAJADEEQUIPOSCOMPUTADORES)
        {
